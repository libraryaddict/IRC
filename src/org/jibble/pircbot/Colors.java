...
public class Colors {
   ...
   */
  public static final String DARK_GREEN = "\u00033";
   ...
   * Olive coloured text.
   */
  public static final String OLIVE = "\u00037";
   ...
   * Green coloured text.
   */
  public static final String GREEN = "\u00039";
   ...
   * 
   *         <p>
   *         This will not work correctly as it has been modified so the colors
   *         will always be in correct IRC or Minecraft format
   */
